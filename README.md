...
Чтобы получить все написанные миграции на свою созданную бд, нужно перейти в консоли в модуль `db-migrations`
и использовать команду если у тебя Windows: 
```
gradlew update -Puser={имя_пользователя_бд} -Purl={адрес_бд} -Ppwd={пароль}
```
Или если у тебя Unix-based:
```
./gradlew update ...
```
