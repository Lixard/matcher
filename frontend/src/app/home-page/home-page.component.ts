...
export class HomePageComponent implements OnInit {
  ...
  description: string = 'Это площадка для студентов, где они смогут найти\n' +
    ...
    '            связаться с ними. Также компании, у которых, возможно, есть какие-то идеи для проектов, на которые они не\n' +
