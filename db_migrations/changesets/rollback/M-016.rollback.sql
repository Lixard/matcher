...
INSERT INTO matcher.projects (project_id, name, description, is_active, org_id) VALUES (1, 'matcher','Лучший проект',true, 1);
INSERT INTO matcher.projects (project_id, name, description, is_active, org_id) VALUES (2, '1Ybit','Сервис ставок',false, 2);
INSERT INTO matcher.projects (project_id, name, description, is_active, org_id) VALUES (3, 'schedule','Сервис составления расписаний занятий',false, 3);
